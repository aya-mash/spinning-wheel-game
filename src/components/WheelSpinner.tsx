...
const WheelSegmentComponent = memo(
  ({ segment, index, segmentDegree }: WheelSegmentProps) => (
    <motion.div
      key={segment.id}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
WheelSegmentComponent.displayName = "WheelSegmentComponent";
...
export const WheelSpinner = memo(
  ({ segments, onSpinComplete, spinDuration = 5000 }: WheelSpinnerProps) => {
    ...
    const handleSegmentChange = useCallback(
      ...
      [segments.length, validateSegmentSelection]
    );
